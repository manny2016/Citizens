...
namespace Citizens.Core
{
    ...
    public abstract class CitizensWorkItem<T> : ICitizensWorkItem
        where T : IWorkItemState
    {
        protected CancellationTokenSource Cancellation;
        private static readonly log4net.ILog Logger = log4net.LogManager.GetLogger(typeof(CitizensWorkItem<T>));
        public CitizensWorkItem(T state)
        {
        ...
        object ICitizensWorkItem.WorkItemState { get { return this.WorkItemState; } }
        public void Abort()
        {
